        ...
        <div className="flex flex-col xl:flex-row gap-[30px]">
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            <form
              ...
              className="flex flex-col gap-6 p-10 bg-[#41729f] rounded-xl"
            >
            ...
            <ul className="flex flex-col gap-10">
              {info.map((item, index) => (
                <li key={index} className="flex items-center gap-6">
                  <div className="w-[52px] h-[52px] xl:w-[72px] xl:h-[72px] bg-[#41729f] text-accent rounded-md flex items-center justify-center">
